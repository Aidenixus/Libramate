...
<div class = "name"> @<%= session.getAttribute("username") %></div>
  ...
  <button class="tablinks" onclick="openFo(event, 'following')">following</button>
   ...
   <form action = "profileServlet">
    ...
    <form action = "unfollowServlet">
    <div class = "followbutton">
    	<input type="image" id = "image" name="unfollow" value= "unfollow" src= "unfollow.png"/>
    	<input type="text" id = "unfollower" name="unfollowername" value =  <%= session.getAttribute("userOldName") %> style="visibility:hidden;"/>
    	<input type="text" id = "unfollowed" name="unfollowedname" value = <%= session.getAttribute("username") %> style="visibility:hidden;" />
