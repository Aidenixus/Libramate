...
<body>
    ...
    <script>
      ...
      for (var i = 0; i < response.length; i++) {
        ...
        var img = "";
        img = item.imageURL; // remember that this is an arraylist
        if (i == 0)
        {
        ...
        contentString += "<td valign='top'><a href=trans.jsp?username="
        		+ username + "&img=" + "<%=session.getAttribute("user")%>" + ">" + "<br><img src=\"" + img+"\">";
      ...
      document.getElementById("content").innerHTML = contentString;
    		...
    		{
    		document.getElementById("content").innerHTML = "<div id = 'nofound'> No User Found! </div>";
    		}
    }
    ...
    <script><%= session.getAttribute("json") %></script>
