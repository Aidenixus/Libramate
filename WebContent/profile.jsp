...
<div class="logout">
		<a href="home.jsp"><img src = "logout.png" /></a>
		</div>
<div class = "name"> @<%= session.getAttribute("username") %></div>
    ...
    <div class = "reading" id = "reading"> Reading:
    </div>
    <div class = "favi" id = "favi">Favorite:  </div>
    <div class = "libraryname" id = "libraryname"> Your Library</div>
    <div class="tab">
  ...
  <button class="tablinks" onclick="openFo(event, 'following')">following</button>
    ...
    <div class = "profilep">
    	<input type="image" id = "image1" name="profile" value= <%= session.getAttribute("user") %> src= <%= session.getAttribute("user") %> />
    </div>
    </form>
</body>
<script>
